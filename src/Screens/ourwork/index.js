...
<section className="info-section d-flex justify-content-center align-items-center py-5">
      <div className="container">
        <p className="info-text text-start">
          We have multiple programs that assist people who are homeless or at risk of being homeless. Our shelters and
          supportive service programs provide assistance to our community’s most vulnerable population. HIS-OC does not
          and shall not discriminate on the basis of race, color, religion (creed), gender, gender expression, age,
          national origin (ancestry), disability, marital status, sexual orientation, or military status, in any of its
      ...
      <div className="row">
                ...
                <h5 className="mb-1">
                  {program.title.split(' ').map((word, i) => (
                    <span
                      key={i}
                      className={
                        hoveredProgram === program && program.highlightedWords.includes(word)
                          ? 'highlighted-word'
                          : ''
                      }
                    >
        ...
        <div className="col-lg-6 d-none d-lg-block">
          <div className="image-container position-relative">
            <img
              src={hoveredProgram ? hoveredProgram.imgSrc : 'path_to_image/default_image.jpg'}
              alt="Hovered Program"
              className="img-fluid"
...
<section className="dedicatd-leadership">
      ...
      HIS-OC’S Mission Is A Dedicated   <span className="dedication  position-relative">Leadership   <img className="dedicationunderline" src={dedicationunderline}/></span>
      Team
      </h2>
      <p className="para text-start text-muted mb-5">
      Our Program Director oversees the strategic direction of all services at HIS-OC, ensuring that every initiative is designed to provide long-term solutions to homelessness. With years of experience in social services, the Program Director.
      </p>
      </div>
      <Slider {...settings}>
